...
- `test_kmplot.do` covers functional behavior, options, error handling,
  state restoration, graph export, and regression paths.
...
| Confidence intervals and transforms | `test_kmplot.do`, `validation_kmplot.do` |
| Median lines and stored medians | `test_kmplot.do`, `validation_kmplot.do` |
| Risk table, `riskevents`, `riskcompact`, `riskmono`, `timepoints()` | `test_kmplot.do`, `validation_kmplot.do` |
| Censor marks and `censorthin()` | `test_kmplot.do` |
| P-value computation and positioning | `test_kmplot.do`, `validation_kmplot.do` |
