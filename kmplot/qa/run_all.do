...
local core_suites "`quick_suites' test_kmplot_v124.do test_kmplot_v125.do test_kmplot_v126.do test_kmplot_v127.do test_kmplot_v128.do validation_kmplot_recovery.do validation_kmplot.do"
