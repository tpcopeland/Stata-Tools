...
The comprehensive demo script (`finegray/demo/demo_finegray.do`) installs the local package, exercises the current 1.2.0 public workflows, verifies exported CIF data, and refreshes the graph below. Run it from the Stata-Tools repository root with `stata-mp -b do finegray/demo/demo_finegray.do`.
