...
- **1.2.1** (2026-07-15; Pending SSC release): Correctness and QA hardening for the delayed-entry release.
...
- **1.2.0** (2026-07-15; Never released to SSC; superseded by 1.2.1): Left-truncation estimator, opt-in baseline, and a hardened QA gate. Supersedes the never-released 1.1.x line.
