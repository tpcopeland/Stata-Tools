...
- 2026-09-14 10:53 UTC, 1.3.5 tree (ffbd2e7b plus one help-file rewrap; delayed-entry censoring KM on Geskus's tie ordering and on the identifiable region): PASS 3/3 -- recovery 8/8, coverage 1/1 (1000/1000 fits on every candidate; fixed-weight sandwich coverage .941-.957, ts_mod .946/.940 as on 2026-09-12; nuisance-adjusted .941-.957 on the pooled arms), factorization 10/10. The four transfer arms are bit-identical to c7ca4445 -- the arms' continuous DGPs have neither event/censoring ties nor an observation gap -- so the pin stays at c7ca4445. A first attempt on 2026-09-13/14 had failed the coverage gate on one replication (light_n500 rep 104) because a `nuisance`-across-a-gap refusal added during development refused that fit; the refusal was withdrawn on the exact-identity evidence in `test_finegray_v135.do` T7 and the lane re-run.
