...
| [iivw](https://github.com/tpcopeland/Stata-Tools/tree/main/iivw) | ![version](https://img.shields.io/badge/version-4.0.1-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--30-brightgreen) | Inverse intensity/visit weighting for irregular longitudinal data (Stata 17+ for mixed models) |
...
| [psdash](https://github.com/tpcopeland/Stata-Tools/tree/main/psdash) | ![version](https://img.shields.io/badge/version-1.6.9-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--30-brightgreen) | Propensity score diagnostics dashboard: overlap, balance, weight distribution, and common support |
...
| [eplot](https://github.com/tpcopeland/Stata-Tools/tree/main/eplot) | ![version](https://img.shields.io/badge/version-1.2.9-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--30-brightgreen) | Unified effect plotting from variables, stored estimates, matrices, or graph-ready frames |
...
| [tabtools](https://github.com/tpcopeland/Stata-Tools/tree/main/tabtools) | ![version](https://img.shields.io/badge/version-2.0.1-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--30-brightgreen) | Excel-ready manuscript tables with optional eplot forest-plot companions for regression, treatment-effect, composite, and survival workflows (Stata 17+) |
