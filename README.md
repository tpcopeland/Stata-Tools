...
| Package | Version | Updated | Description |
| --- | --- | --- | --- |
| [setools](https://github.com/tpcopeland/Stata-Tools/tree/main/setools) | ![version](https://img.shields.io/badge/version-1.5.2-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--05-brightgreen) | Swedish registry tools for Charlson scoring, migrations, and MS progression endpoints |
