...
| [codescan](https://github.com/tpcopeland/Stata-Tools/tree/main/codescan) | ![version](https://img.shields.io/badge/version-4.1.5-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--19-brightgreen) | Scan wide-format diagnosis, procedure, and medication code fields with indicator, count, and summary outputs |
...
| [datamap](https://github.com/tpcopeland/Stata-Tools/tree/main/datamap) | ![version](https://img.shields.io/badge/version-1.6.7-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--19-brightgreen) | Privacy-safe dataset maps, Markdown dictionaries, console QC/expectation gates (datacheck), and missing-value pattern analysis (datamvp) |
...
| [fvgen](https://github.com/tpcopeland/Stata-Tools/tree/main/fvgen) | ![version](https://img.shields.io/badge/version-1.2.4-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--11-brightgreen) | Flatten factor-variable interactions into labeled main and product variables for clean regression export |
...
| [rangematch](https://github.com/tpcopeland/Stata-Tools/tree/main/rangematch) | ![version](https://img.shields.io/badge/version-1.5.3-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--13-brightgreen) | Range join between master and using datasets (file or frame) via a Mata binary-search backend (Stata 16.1+) |
...
| [finegray](https://github.com/tpcopeland/Stata-Tools/tree/main/finegray) | ![version](https://img.shields.io/badge/version-1.3.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--26-brightgreen) | Fast Fine-Gray competing risks regression with prediction, cumulative incidence, and a proportional subdistribution hazards diagnostic |
| [gcomp](https://github.com/tpcopeland/Stata-Tools/tree/main/gcomp) | ![version](https://img.shields.io/badge/version-2.0.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--19-brightgreen) | Parametric g-computation for mediation and time-varying confounding (includes gcomptab) |
| [iivw](https://github.com/tpcopeland/Stata-Tools/tree/main/iivw) | ![version](https://img.shields.io/badge/version-4.0.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--19-brightgreen) | Inverse intensity/visit weighting for irregular longitudinal data (Stata 17+ for mixed models) |
| [msm](https://github.com/tpcopeland/Stata-Tools/tree/main/msm) | ![version](https://img.shields.io/badge/version-1.4.6-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--11-brightgreen) | Marginal structural models for longitudinal causal analysis with IPTW, diagnostics, prediction, plots, and reports |
| [psdash](https://github.com/tpcopeland/Stata-Tools/tree/main/psdash) | ![version](https://img.shields.io/badge/version-1.6.8-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--11-brightgreen) | Propensity score diagnostics dashboard: overlap, balance, weight distribution, and common support |
...
| [setools](https://github.com/tpcopeland/Stata-Tools/tree/main/setools) | ![version](https://img.shields.io/badge/version-1.5.5-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--13-brightgreen) | Swedish registry tools for Charlson scoring, migrations, and MS progression endpoints |
| [tvtools](https://github.com/tpcopeland/Stata-Tools/tree/main/tvtools) | ![version](https://img.shields.io/badge/version-1.16.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--13-brightgreen) | Time-varying exposure workflow for survival analysis, diagnostics, IPTW/IPCW weights, and age-band intervals |
...
| [logdoc](https://github.com/tpcopeland/Stata-Tools/tree/main/logdoc) | ![version](https://img.shields.io/badge/version-1.1.6-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--24-brightgreen) | Convert Stata SMCL/log files to faithful HTML, Markdown, Word, LaTeX, Quarto, or PDF documents (requires Python 3.6+) |
...
| [tabtools](https://github.com/tpcopeland/Stata-Tools/tree/main/tabtools) | ![version](https://img.shields.io/badge/version-2.0.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--20-brightgreen) | Excel-ready manuscript tables with optional eplot forest-plot companions for regression, treatment-effect, composite, and survival workflows (Stata 17+) |
