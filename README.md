...
| [codescan](https://github.com/tpcopeland/Stata-Tools/tree/main/codescan) | ![version](https://img.shields.io/badge/version-4.1.4-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--13-brightgreen) | Scan wide-format diagnosis, procedure, and medication code fields with indicator, count, and summary outputs |
...
| [pkgtransfer](https://github.com/tpcopeland/Stata-Tools/tree/main/pkgtransfer) | ![version](https://img.shields.io/badge/version-1.0.5-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--11-brightgreen) | Transfer installed package sets between systems via online reinstall or offline ZIP |
...
| [iivw](https://github.com/tpcopeland/Stata-Tools/tree/main/iivw) | ![version](https://img.shields.io/badge/version-3.4.2-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--11-brightgreen) | Inverse intensity/visit weighting for irregular longitudinal data (Stata 17+ for mixed models) |
...
| [tabtools](https://github.com/tpcopeland/Stata-Tools/tree/main/tabtools) | ![version](https://img.shields.io/badge/version-1.15.1-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--14-brightgreen) | Excel-ready manuscript tables with optional eplot forest-plot companions for regression, treatment-effect, composite, and survival workflows (Stata 17+ for most commands) |
