...
| [rangematch](https://github.com/tpcopeland/Stata-Tools/tree/main/rangematch) | ![version](https://img.shields.io/badge/version-1.5.2-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--10-brightgreen) | Range join between master and using datasets (file or frame) via a Mata binary-search backend (Stata 16.1+) |
...
| [iivw](https://github.com/tpcopeland/Stata-Tools/tree/main/iivw) | ![version](https://img.shields.io/badge/version-3.4.1-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--10-brightgreen) | Inverse intensity/visit weighting for irregular longitudinal data (Stata 17+ for mixed models) |
...
| [psdash](https://github.com/tpcopeland/Stata-Tools/tree/main/psdash) | ![version](https://img.shields.io/badge/version-1.6.5-blue) | ![updated](https://img.shields.io/badge/updated-2026--08--10-brightgreen) | Propensity score diagnostics dashboard: overlap, balance, weight distribution, and common support |
