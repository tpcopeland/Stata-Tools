...
| --- | --- | --- | --- |
| [codescan](https://github.com/tpcopeland/Stata-Tools/tree/main/codescan) | ![version](https://img.shields.io/badge/version-4.1.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--07--25-brightgreen) | Scan wide-format diagnosis, procedure, and medication code fields with indicator, count, and summary outputs |
...
| [iivw](https://github.com/tpcopeland/Stata-Tools/tree/main/iivw) | ![version](https://img.shields.io/badge/version-3.1.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--07--25-brightgreen) | Inverse intensity/visit weighting for irregular longitudinal data (Stata 17+ for mixed models) |
| [msm](https://github.com/tpcopeland/Stata-Tools/tree/main/msm) | ![version](https://img.shields.io/badge/version-1.4.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--07--26-brightgreen) | Marginal structural models for longitudinal causal analysis with IPTW, diagnostics, prediction, plots, and reports |
| [psdash](https://github.com/tpcopeland/Stata-Tools/tree/main/psdash) | ![version](https://img.shields.io/badge/version-1.6.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--07--26-brightgreen) | Propensity score diagnostics dashboard: overlap, balance, weight distribution, and common support |
| [qba](https://github.com/tpcopeland/Stata-Tools/tree/main/qba) | ![version](https://img.shields.io/badge/version-1.1.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--07--26-brightgreen) | Quantitative bias analysis for misclassification, selection bias, and unmeasured confounding, with multi-bias chains and visualization (simple and probabilistic) |
...
| [tvtools](https://github.com/tpcopeland/Stata-Tools/tree/main/tvtools) | ![version](https://img.shields.io/badge/version-1.9.0-blue) | ![updated](https://img.shields.io/badge/updated-2026--07--25-brightgreen) | Time-varying exposure workflow for survival analysis, diagnostics, IPTW/IPCW weights, and age-band intervals |
