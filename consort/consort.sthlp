...
{phang2}{stata `"consort save, output("consort/examples/consort_diagram.png") final("Final Analytic Cohort") dpi(300)"':. consort save, output("consort/examples/consort_diagram.png") final("Final Analytic Cohort") dpi(300)}{p_end}
...
{phang2}{stata `"consort save, output("consort/examples/figure1.png") final("Study population") shading dpi(300)"':. consort save, output("consort/examples/figure1.png") final("Study population") shading dpi(300)}{p_end}
