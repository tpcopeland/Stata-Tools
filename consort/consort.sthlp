...
steps. The diagram counts are recorded from each exclusion step, while the
console summary uses the current dataset. Manual changes between steps will
cause these counts to diverge.
...
{phang2}{stata `"consort exclude if missing(education), label("Missing education data")"':. consort exclude if missing(education), label("Missing education data")}{p_end}
{phang2}{stata `"consort save, output("consort_diagram.png") final("Final Analytic Cohort") dpi(300)"':. consort save, output("consort_diagram.png") final("Final Analytic Cohort") dpi(300)}{p_end}


{pstd}
{bf:Example 2: With milestone labels}
...
{phang2}{cmd:. consort exclude if missing(death_date) == 0 & death_date <= study_entry + 1, label("Death within 1 day of entry")}{p_end}
{phang2}{stata `"consort save, output("figure1.png") final("Study population") shading dpi(300)"':. consort save, output("figure1.png") final("Study population") shading dpi(300)}{p_end}
...
{phang2}{stata `"consort init, initial("Source population")"':. consort init, initial("Source population")}{p_end}
{phang2}{stata `"consort exclude if condition1, label("Criterion 1")"':. consort exclude if condition1, label("Criterion 1")}{p_end}
{phang2}{stata `"consort exclude if condition2, label("Criterion 2")"':. consort exclude if condition2, label("Criterion 2")}{p_end}
{phang2}{stata `"consort save, output("diagram.png")"':. consort save, output("diagram.png")}{p_end}
...
{p 8 12 2}- Python 3.7 or higher{p_end}
