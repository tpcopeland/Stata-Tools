...
{synoptset 24 tabbed}{...}
{synoptline}
{synopt:{opt spe:arman}}compute Spearman rank correlations instead of Pearson; recommended for ordinal, skewed, or nonlinear monotonic relationships{p_end}
...
{helpb tabtools_cheatsheet}, {helpb pwcorr}, {helpb spearman}
{p_end}
