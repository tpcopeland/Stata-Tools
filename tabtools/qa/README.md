...
| Lane | Files |
|------|-------|
| `quick` | 28 explicitly listed `test_*.do` files (all except `test_package_adversarial.do`) |
| `full` | 29 tests + 11 validations + `crossval_tabtools.do` (41 files) |
| `release` | `full` plus `benchmark_tabtools_speed.do` (42 files) |
