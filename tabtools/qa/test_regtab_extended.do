...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/regtab_ext_test1.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/regtab_ext_test2.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/regtab_ext_test3.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/regtab_ext_test4.xlsx") ///
...
* List output files
dir "`base_path'/_devkit/_testing/output/regtab_ext_*.xlsx"
