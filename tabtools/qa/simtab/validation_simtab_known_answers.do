* validation_simtab_known_answers.do - exact known-answer + simsum oracle for simtab
...
log using "validation_simtab_known_answers.log", replace text name(_simtabval)
...
if _rc {
    display as text "  SKIP simsum oracle: simsum not installed"
}
else {
    clear
    set obs 1000
