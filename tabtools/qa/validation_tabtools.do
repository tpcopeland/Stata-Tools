...
capture mkdir "`base_path'/_devkit/_testing/output/validation"
...
capture tablex using "`base_path'/_devkit/_testing/output/validation/val_tablex1.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/validation/val_tablex2.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/validation/val_tablex3.xlsx", ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/validation/val_regtab1.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/validation/val_regtab2.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/validation/val_regtab3.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/validation/val_regtab4.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/validation/val_regtab5.xlsx") ///
...
capture regtab, xlsx("`base_path'/_devkit/_testing/output/validation/val_regtab6.xlsx") ///
...
capture table1_tc, by(foreign) ///
    ...
    excel("`base_path'/_devkit/_testing/output/validation/val_table1tc.xlsx") ///
...
display as text "=============================================="
display ""
display as text "Output files in: `base_path'/_devkit/_testing/output/validation/"

* List output files
dir "`base_path'/_devkit/_testing/output/validation/*.xlsx"
