...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test1.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test2.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test3.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test4.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test5.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test6.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test7.xlsx", ///
...
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test8.xlsx", ///
...
* First table
table foreign, statistic(mean price)
capture tablex using "`base_path'/_devkit/_testing/output/tablex_test9.xlsx", ///
...
display as text "=============================================="
display as text "Output files created in: `base_path'/_devkit/_testing/output/"
display ""
...
* List output files
dir "`base_path'/_devkit/_testing/output/tablex_*.xlsx"
