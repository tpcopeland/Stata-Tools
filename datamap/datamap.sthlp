...
{phang2}{stata "datamap, directory(_examples) exclude(id) datesafe output(datamap/examples/synthdata_documentation.txt)":. datamap, directory(_examples) ///}{p_end}
{phang2}{cmd:     exclude(id) datesafe ///}{p_end}
{phang2}{cmd:     output(datamap/examples/synthdata_documentation.txt)}{p_end}
