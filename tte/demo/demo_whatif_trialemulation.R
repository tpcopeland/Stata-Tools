#!/usr/bin/env Rscript
# ==============================================================================
# demo_whatif_trialemulation.R — What If Programs 17.2 and 17.3 in R
#
# Replicates:
...
#   demo_whatif_emulate.R       — R (emulate package)
#
...
output_dir <- file.path(getwd(), "demo_output_trialemulation")
...
# IP-weighted pooled logistic (NO covariates in outcome model)
...
# Plot IP-weighted survival (Figure 17.6)
