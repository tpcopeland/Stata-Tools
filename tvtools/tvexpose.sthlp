...
{synopt:{opt merge(#)}}days within which to merge same-type periods (default: 120){p_end}
...
occur within # days of each other. Default is 120 days. Useful for treating
