...
display as result "tvtools QA: tvexpose correctness -- $S_DATE $S_TIME"


**# ===== merged from validation_tvtools.do L4510-13037: SECTION 5 TVEXPOSE person-time validation =====
...
display as result _newline "tvtools QA tvexpose correctness Results -- $S_DATE $S_TIME"
display as text "Tests run:  `test_count'"
display as text "Passed:     `pass_count'"
display as text "Failed:     `fail_count'"
display "RESULT: validation_tvexpose tests=`test_count' pass=`pass_count' fail=`fail_count'"
if `fail_count' > 0 {
