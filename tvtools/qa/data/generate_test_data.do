...
*   2. Datasets will be saved in tvtools/qa/data/
*   3. Use these datasets to run the test_*.do files in tvtools/qa/
*
* Output datasets:
...
* PATH CONFIGURATION
* =============================================================================
* Run from tvtools/qa/data/ — datasets are saved in current directory
global DATA_DIR "`c(pwd)'"

* Install tvtools from package root (two levels up from qa/data/)
capture net uninstall tvtools
quietly net install tvtools, from("`c(pwd)'/../..") replace

display as text _n "Output directory: ${DATA_DIR}"
...
* Additional demographic and clinical variables (for package tests)
