...
* test_tvtools.do
*
* Functional tests for all tvtools commands:
*   tvage, tvdiagnose, tvevent, tvexpose, tvmerge, tvtools, tvweight
*
* Usage:
...
display as result "tvtools Functional Test Suite -- $S_DATE $S_TIME"
...
display as result _newline "tvtools Test Results -- $S_DATE $S_TIME"
