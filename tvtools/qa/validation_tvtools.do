...
*
* Validation tests for all tvtools commands:
*   Mathematical correctness, known-answer tests, registry scenarios
*
* Commands validated:
*   tvage, tvdiagnose, tvevent, tvexpose, tvmerge, tvweight
*
* Usage:
...
display as result "tvtools Validation Suite -- $S_DATE $S_TIME"
...
display as result _newline "tvtools Validation Results -- $S_DATE $S_TIME"
