...
capture log close
quietly log using "test_tvexpose.log", replace nomsg
...
display as result "tvtools QA: tvexpose functional -- $S_DATE $S_TIME"


**# ===== merged from test_tvtools.do L2236-5451: SECTION 5 TVEXPOSE =====
...
display as result _newline "tvtools QA tvexpose functional Results -- $S_DATE $S_TIME"
display as text "Tests run:  `test_count'"
display as text "Passed:     `pass_count'"
display as text "Failed:     `fail_count'"
display "RESULT: test_tvexpose tests=`test_count' pass=`pass_count' fail=`fail_count'"
if `fail_count' > 0 {
