...
{phang2}{stata "logit tv_exposure age sex comorbidity_score":. logit tv_exposure age sex comorbidity_score}{p_end}
{phang2}{stata "predict ps, pr":. predict ps, pr}{p_end}
{phang2}{stata "gen iptw = cond(tv_exposure==1, 1/ps, 1/(1-ps))":. gen iptw = cond(tv_exposure==1, 1/ps, 1/(1-ps))}{p_end}
{phang2}{stata "tvbalance age sex comorbidity_score, exposure(tv_exposure) weights(iptw)":. tvbalance age sex comorbidity_score, exposure(tv_exposure) weights(iptw)}{p_end}

{pstd}Generate Love plot with stricter threshold{p_end}
{phang2}{stata "tvbalance age sex comorbidity_score, exposure(tv_exposure) weights(iptw) threshold(0.05) loveplot scheme(plotplainblind)":. tvbalance age sex comorbidity_score, exposure(tv_exposure) weights(iptw) threshold(0.05) loveplot scheme(plotplainblind)}{p_end}

{pstd}Save Love plot{p_end}
{phang2}{stata "tvbalance age sex, exposure(tv_exposure) loveplot saving(balance.png) replace":. tvbalance age sex, exposure(tv_exposure) loveplot saving(balance.png) replace}{p_end}
