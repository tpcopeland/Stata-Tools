...
{p 8 20 2}
{cmd:tvsensitivity}{cmd:,} {opt rr(#)} [{opt method(string)} {opt cilow(#)} {opt rru(numlist)} {opt rrou(numlist)}]
...
{phang2}{stata "tvsensitivity, rr(1.5)":. tvsensitivity, rr(1.5)}{p_end}
{phang2}{stata "tvsensitivity, rr(2.0) method(bias)":. tvsensitivity, rr(2.0) method(bias)}{p_end}
