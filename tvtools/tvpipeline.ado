*! tvpipeline Version 1.0.2  2026/02/23
...
program define tvpipeline, rclass
    ...
    * Count initial observations
    ...
    local n_cohort = r(N)
    tempvar _id_tag1
    quietly egen byte `_id_tag1' = tag(`id')
    quietly count if `_id_tag1'
    local n_ids = r(N)
    ...
    * Build tvexpose command
    local tv_exp_var "tv_exposure"
    local tvexpose_cmd `"tvexpose using "`expfile'", id(`id') start(`start') stop(`stop') exposure(`exposure') reference(`reference') entry(`entry') exit(`exit') generate(`tv_exp_var')"'
    ...
    * Store tvexpose results
    ...
    tempvar _id_tag2
    quietly egen byte `_id_tag2' = tag(`id')
    quietly count if `_id_tag2'
    local n_ids_after = r(N)
    ...
    * =========================================================================
    ...
    if "`diagnose'" != "" {
        ...
        * Run tvdiagnose
        capture noisily tvdiagnose, id(`id') start(start) stop(stop) exposure(`tv_exp_var') gaps overlaps summarize
    ...
    * =========================================================================
    ...
    if "`balance'" != "" {
        ...
        * Run tvbalance
        capture noisily tvbalance `balance', exposure(`tv_exp_var')
    ...
    * =========================================================================
    ...
    if "`plot'" != "" {
        ...
        * Run tvplot (swimlane for first 20 individuals)
        capture noisily tvplot, id(`id') start(start) stop(stop) exposure(`tv_exp_var') swimlane sample(20)
    ...
    * =========================================================================
    ...
    display as text "  `tv_exp_var'" _col(19) "- Time-varying exposure status"
