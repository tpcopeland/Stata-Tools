...
{phang2}{stata "gen id = _n":. gen id = _n}{p_end}
{phang2}{stata "gen study_entry = mdy(1, 1, 2020) + floor(runiform() * 30)":. gen study_entry = mdy(1, 1, 2020) + floor(runiform() * 30)}{p_end}
{phang2}{stata "gen study_exit = study_entry + 365 + floor(runiform() * 180)":. gen study_exit = study_entry + 365 + floor(runiform() * 180)}{p_end}
{phang2}{stata "gen rx_start = .":. gen rx_start = .}{p_end}
{phang2}{stata "replace rx_start = study_entry + floor(runiform() * 200) if runiform() < 0.4":. replace rx_start = study_entry + floor(runiform() * 200) if runiform() < 0.4}{p_end}
{phang2}{stata "format %td study_entry study_exit rx_start":. format %td study_entry study_exit rx_start}{p_end}

{pstd}Basic target trial emulation{p_end}
{phang2}{stata "tvtrial, id(id) entry(study_entry) exit(study_exit) treatstart(rx_start)":. tvtrial, id(id) entry(study_entry) exit(study_exit) treatstart(rx_start)}{p_end}
...
{phang2}{stata "tvtrial, id(id) entry(study_entry) exit(study_exit) treatstart(rx_start) clone graceperiod(30)":. tvtrial, id(id) entry(study_entry) exit(study_exit) treatstart(rx_start) clone graceperiod(30)}{p_end}

{pstd}Full approach with IPCW{p_end}
{phang2}{stata "tvtrial, id(id) entry(study_entry) exit(study_exit) treatstart(rx_start) clone ipcweight graceperiod(30)":. tvtrial, id(id) entry(study_entry) exit(study_exit) treatstart(rx_start) clone ipcweight graceperiod(30)}{p_end}
