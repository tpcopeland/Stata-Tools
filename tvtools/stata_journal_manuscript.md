...
A key feature of tvexpose is the flexibility in defining how exposures are represented. Six exposure definitions are available:
...
### 7.5 Multiple concurrent exposures
...
### 7.6 Current versus former exposure
...
### 7.7 Grace periods and gap handling
...
**Comprehensive exposure definitions.** The six exposure definitions in tvexpose cover the most common analytical frameworks in pharmacoepidemiology and occupational health research.
...
- **Flexibility:** Six exposure definitions cover common analytical frameworks
