...
program define cdp, rclass
    ...
    if "`roving'" == "" {
        ...
        // than "confirmed at next visit" definitions - it requires the
        // progression to be sustained throughout the entire follow-up period.
