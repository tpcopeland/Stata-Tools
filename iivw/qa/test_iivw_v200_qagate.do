...
* test_iivw_v200_qagate.log into qa/, which is gitignored but is still ~4 MB of debris carrying the
...
display "RESULT: test_iivw_v200_qagate tests=`test_count' pass=`pass_count' fail=`fail_count'"
