...
*
* Sensitivity analysis extending Scenario C with two complications:
...
*
* Otherwise the DGP matches Scenario C from sim_scenarios_abc.do:
*   treatment confounded by conf_ti and u_i, informative visit process,
*   true treatment effect = 0.5, artifact = coef * log(min(test_n, 6) + 1).
*
* Usage:
*   do iivw/qa/sim_scenario_d.do              QA gate (fewer reps)
*   do iivw/qa/sim_scenario_d.do manuscript    Full 1000 replications
*
* See: iivw_manuscript (Section 4.6), Table 2
...
program define _sim_generate_d
    ...
    * Informative visit process (same as Scenario C)
