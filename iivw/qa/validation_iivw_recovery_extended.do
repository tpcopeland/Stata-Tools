...
capture noisily {
    ...
    iivw_weight, id(id) time(months) visit_cov(Z S) stabcov(S) wtype(iivw) nolog replace
...
capture noisily {
    ...
    iivw_weight, id(id) time(months) visit_cov(Z) entry(entry0) wtype(iivw) nolog replace
    iivw_fit y, timespec(linear) nolog replace
...
capture noisily {
    ...
    iivw_weight, id(id) time(months) visit_cov(Z) wtype(iivw) nobaseevent nolog replace
    iivw_fit y, timespec(linear) nolog replace
...
capture noisily {
    ...
    iivw_weight, id(id) time(months) visit_cov(Z) lagvars(W) wtype(iivw) nolog replace
    iivw_fit y, timespec(linear) nolog replace
...
capture noisily {
    ...
    iivw_weight, id(id) time(months) visit_cov(Z) wtype(iivw) truncate(1 99) nolog replace
    iivw_fit y, timespec(linear) nolog replace
