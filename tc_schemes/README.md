...
| ![Colorblind-friendly gray-background ggplot-inspired style](demo/scheme_plottigblind.png) | `plottigblind` |
...
| ![White-background Paul Tol colorblind-safe palette](demo/scheme_white_ptol.png) | `white_ptol` |
| ![Black-background Tableau palette](demo/scheme_black_tableau.png) | `black_tableau` |
| ![Black-background perceptually uniform cividis palette](demo/scheme_black_cividis.png) | `black_cividis` |
| ![Gray-background hue palette](demo/scheme_gg_hue.png) | `gg_hue` |
| ![High-contrast neon standalone scheme](demo/scheme_neon.png) | `neon` |
| ![Taylor Swift Red-inspired standalone palette](demo/scheme_swift_red.png) | `swift_red` |
