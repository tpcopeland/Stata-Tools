...
do "`qa_dir'/_record_qa_result.do" test_msm_fit_guidance ///
    `test_count' `pass_count' `fail_count' 0
display as text "RESULT: test_msm_fit_guidance tests=`test_count' pass=`pass_count' fail=`fail_count' skip=0"
if `fail_count' > 0 {
