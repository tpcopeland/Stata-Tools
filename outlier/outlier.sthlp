...
{phang2}{stata "outlier price mpg weight":. outlier price mpg weight}{p_end}

{pstd}
{bf:Example 2: SD-based with custom threshold}

{phang2}{stata "outlier price, method(sd) multiplier(2.5)":. outlier price, method(sd) multiplier(2.5)}{p_end}

{pstd}
{bf:Example 3: Flag outliers and generate indicator}

{phang2}{stata "outlier price mpg, generate(out_) action(flag)":. outlier price mpg, generate(out_) action(flag)}{p_end}

{pstd}
{bf:Example 4: Winsorize outliers}

{phang2}{stata "outlier price, action(winsorize) generate(w_)":. outlier price, action(winsorize) generate(w_)}{p_end}

{pstd}
{bf:Example 5: Multivariate Mahalanobis}

{phang2}{stata "outlier price mpg weight, method(mahal) generate(maha_)":. outlier price mpg weight, method(mahal) generate(maha_)}{p_end}

{pstd}
{bf:Example 6: Regression influence}

{phang2}{stata "outlier price mpg weight headroom, method(influence) generate(infl_)":. outlier price mpg weight headroom, method(influence) generate(infl_)}{p_end}

{pstd}
{bf:Example 7: Detection within groups}

{phang2}{stata "outlier price, by(foreign) report":. outlier price, by(foreign) report}{p_end}

{pstd}
{bf:Example 8: Export to Excel}

{phang2}{stata "outlier price mpg weight, xlsx(outliers.xlsx)":. outlier price mpg weight, xlsx(outliers.xlsx)}{p_end}
