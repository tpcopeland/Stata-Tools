*! outlier Version 1.0.1  2026/02/26
...
program define outlier, rclass
    ...
    * =========================================================================
    if "`method'" == "mahal" {
        ...
        * =====================================================================
        * EXPORT TO EXCEL (must precede return matrix which moves the matrix)
        * =====================================================================
        if "`xlsx'" != "" {
            quietly {
                preserve
        ...
        * Return results (return matrix moves the matrix, so must be last)
        return scalar N = `N'
