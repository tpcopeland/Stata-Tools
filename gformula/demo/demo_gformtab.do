...
* demo_gformtab.do
*
* Purpose: Demonstrate the gformtab command for exporting gformula mediation
*          results to publication-ready Excel tables
*
* Pipeline: generate synthetic data → run gformula → export with gformtab
*
...
* =============================================================================
* RUN GFORMULA MEDIATION ANALYSIS
* =============================================================================
...
gformtab, xlsx(gformula/demo/demo_gformtab.xlsx) sheet("Normal CI") ///
	title("Table 1. Causal Mediation Analysis (Normal CIs)")

* Percentile CIs on a second sheet
gformtab, xlsx(gformula/demo/demo_gformtab.xlsx) sheet("Percentile CI") ///
	ci(percentile) title("Table 2. Mediation Results (Percentile CIs)")

* Custom labels with higher precision
gformtab, xlsx(gformula/demo/demo_gformtab.xlsx) sheet("Custom") ///
