...
{phang2}{stata "massdesas":. massdesas}{p_end}

{pstd}Convert all SAS files in a specific directory{p_end}
{phang2}{stata `"massdesas, directory("C:/Data/SAS_Files")"':. massdesas, directory("C:/Data/SAS_Files")}{p_end}

{pstd}Convert with lowercase variable names{p_end}
{phang2}{stata `"massdesas, directory("C:/Data/SAS_Files") lower"':. massdesas, directory("C:/Data/SAS_Files") lower}{p_end}

{pstd}Convert and delete original SAS files (use with caution!){p_end}
{phang2}{stata `"massdesas, directory("C:/Data/SAS_Files") erase"':. massdesas, directory("C:/Data/SAS_Files") erase}{p_end}
...
{phang2}{stata `"massdesas, directory("C:/Data/SAS_Files_Backup") lower"':. massdesas, directory("C:/Data/SAS_Files_Backup") lower}{p_end}
{phang2}{cmd:. * Verify conversion was successful by opening some files}{p_end}
{phang2}{stata `"use "C:/Data/SAS_Files_Backup/dataset1.dta", clear"':. use "C:/Data/SAS_Files_Backup/dataset1.dta", clear}{p_end}
{phang2}{stata "describe":. describe}{p_end}
{phang2}{cmd:. * If successful, run on actual data}{p_end}
{phang2}{stata `"massdesas, directory("C:/Data/SAS_Files") lower erase"':. massdesas, directory("C:/Data/SAS_Files") lower erase}{p_end}
...
{phang2}{stata `"massdesas, directory("C:/Project") lower"':. massdesas, directory("C:/Project") lower}{p_end}
...
{psee}
Online: {stata ssc describe filelist: ssc describe filelist},
{stata ssc describe fs: ssc describe fs}
{p_end}
