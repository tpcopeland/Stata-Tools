...
if `rc' {
    display "RESULT: test_refactor_saving_parser_adversarial tests=1 pass=0 fail=1"
    exit `rc'
}
display as result "test_refactor_saving_parser_adversarial passed"
display "RESULT: test_refactor_saving_parser_adversarial tests=1 pass=1 fail=0"
