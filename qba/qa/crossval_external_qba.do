...
program define _qba_crossval_external_main
    ...
    * The R oracle writes the sentinel only after the CSV is complete; this is
    * independent of the user's interactive shell syntax.
    tempfile oracle_ok
    capture erase "`oracle_ok'"
    shell Rscript "`oracle_script'" "`oracle_csv'" "`oracle_ok'"
