...
raincloud mpg, over(foreign) seed(2026) ///
    ...
    opacity(65) ///
    title("Element Styling: Custom Cloud, Rain, and Box") ///
    name(styled, replace)
graph export "`pkg_dir'/raincloud_styled.png", name(styled) replace width(1200)
capture graph close styled
