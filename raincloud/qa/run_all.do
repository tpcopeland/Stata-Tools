...
local suites "test_raincloud.do test_raincloud_errors.do test_raincloud_documentation_examples.do test_regressions.do validation_raincloud.do test_package_release.do"
local suite_count 0
local suite_pass 0
local suite_fail 0
local failed ""
