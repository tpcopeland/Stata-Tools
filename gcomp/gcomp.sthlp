...
{phang}
{opt i:dvar(varname)} specifies the subject identifier variable. Required for
time-varying confounding analyses where data are in long format with multiple
rows per subject.

{phang}
{opt t:var(varname)} specifies the time variable identifying the period or
...
{synopt:{cmd:e(mediation_type)}}effect type: {cmd:obe}, {cmd:oce}, {cmd:linexp}, {cmd:specific}, or {cmd:baseline}{p_end}
