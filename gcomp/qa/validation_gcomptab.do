/*******************************************************************************
* validation_gcomptab.do
*
* Purpose: Validation tests for gcomptab command
*          Verifies correctness of formatting and output values
*
* Validation approach:
*   - Use mock gcomp results with known values
...
* =============================================================================
* HELPER: Mock gcomp output (same as in test file)
* =============================================================================
...
capture {
    * Known input values
    ...
    mock_gcomp, tce(`input_tce') nde(`input_nde') nie(`input_nie') ///
        pm(`input_pm') cde(`input_cde')

    gcomptab, xlsx("`testdir'/_val_gcomptab.xlsx") sheet("Test")
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab.xlsx") sheet("NEffects")
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab.xlsx") sheet("Macros")

    assert "`r(xlsx)'" == "`testdir'/_val_gcomptab.xlsx"
...
capture {
    ...
    confirm file "`testdir'/_val_gcomptab_struct.xlsx"
}
if _rc == 0 {
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_values.xlsx") sheet("Values")

    import excel "`testdir'/_val_gcomptab_values.xlsx", sheet("Values") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_ci.xlsx") sheet("CI")

    import excel "`testdir'/_val_gcomptab_ci.xlsx", sheet("CI") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_se.xlsx") sheet("SE")

    import excel "`testdir'/_val_gcomptab_se.xlsx", sheet("SE") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_ci_normal.xlsx") sheet("Normal")
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_ci_pct.xlsx") sheet("Pct") ci(percentile)

    assert "`r(ci)'" == "percentile"
    confirm file "`testdir'/_val_gcomptab_ci_pct.xlsx"
}
if _rc == 0 {
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_ci_bc.xlsx") sheet("BC") ci(bc)
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_ci_bca.xlsx") sheet("BCa") ci(bca)
...
capture {
    mock_gcomp, tce(0.123456) nde(0.100000) nie(0.050000) pm(0.333333) cde(0.080000)

    gcomptab, xlsx("`testdir'/_val_gcomptab_dec3.xlsx") sheet("Dec3")

    import excel "`testdir'/_val_gcomptab_dec3.xlsx", sheet("Dec3") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_labels.xlsx") sheet("Labels") ///
        labels("Total \ Direct \ Indirect \ Pct Med \ CDE")

    import excel "`testdir'/_val_gcomptab_labels.xlsx", sheet("Labels") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_deflabels.xlsx") sheet("DefLabels")

    import excel "`testdir'/_val_gcomptab_deflabels.xlsx", sheet("DefLabels") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_title.xlsx") sheet("Title") ///
        title("Table 1. My Mediation Results")

    import excel "`testdir'/_val_gcomptab_title.xlsx", sheet("Title") clear
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_small.xlsx") sheet("Small") decimal(4)

    confirm file "`testdir'/_val_gcomptab_small.xlsx"
}
if _rc == 0 {
...
capture {
    ...
    gcomptab, xlsx("`testdir'/_val_gcomptab_large.xlsx") sheet("Large")

    confirm file "`testdir'/_val_gcomptab_large.xlsx"
}
if _rc == 0 {
...
local cleanup_files "_val_gcomptab _val_gcomptab_struct _val_gcomptab_values _val_gcomptab_ci _val_gcomptab_se _val_gcomptab_ci_normal _val_gcomptab_ci_pct _val_gcomptab_ci_bc _val_gcomptab_ci_bca _val_gcomptab_dec3 _val_gcomptab_dec4 _val_gcomptab_labels _val_gcomptab_deflabels _val_gcomptab_title _val_gcomptab_neg _val_gcomptab_small _val_gcomptab_large"
