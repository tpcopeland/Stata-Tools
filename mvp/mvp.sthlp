...
{hline}
help for {cmd:mvp}{right:version 1.1.2}
{hline}
...
{phang2}{stata "mvp var1 var2 var3 var4, monotone":. mvp var1 var2 var3 var4, monotone}{p_end}

{pstd}Show correlations among missingness indicators{p_end}
{phang2}{stata "mvp income education occupation, correlate":. mvp income education occupation, correlate}{p_end}
...
{phang2}{stata "mvp outcome1-outcome5, graph(patterns) gby(treatment) top(10)":. mvp outcome1-outcome5, graph(patterns) gby(treatment) top(10)}{p_end}
