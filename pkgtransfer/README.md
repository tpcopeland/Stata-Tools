...
- **Version 1.0.3** (6 March 2026): Bug fixes and documentation
  ...
  - Fixed varabbrev setting leaking into user session
  - Improved directory cleanup for nested subdirectories
  - Made restore option more robust against variable stata.trk entry sizes
  - Documented all options (skip, restore, os, dofile, zipfile) in help file
  - Aligned version requirements across all files (Stata 16+)
