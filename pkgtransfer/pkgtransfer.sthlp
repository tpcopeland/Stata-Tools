...
{phang}
{opt restore} restores installation pathways in {cmd:stata.trk} to point to original online sources after a local installation. This works only for packages installed from {cmd:pkgtransfer}-generated ZIP archives, which embed the original source URL as backup metadata. A backup of {cmd:stata.trk} is created before modification.
...
{pstd}Version 1.0.4 - 2026-03-13{p_end}
